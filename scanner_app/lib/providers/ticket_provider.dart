...
class TicketProvider extends ChangeNotifier {
  ...
  Future<void> fetchTickets() async {
    debugPrint('TicketProvider.fetchTickets() called');
    _isLoading = true;
    _errorMessage = null;
    notifyListeners();
  ...
  Future<Map<String, dynamic>> buyTicket({
    ...
    debugPrint('TicketProvider.buyTicket() called for event: $eventId, type: $ticketType');
    _isLoading = true;
    notifyListeners();
  ...
  Future<Map<String, dynamic>> transferTicket(String ticketId, String toPhone) async {
    debugPrint('TicketProvider.transferTicket() called. Ticket: $ticketId, To: $toPhone');
    try {
